...
Game.Launch=function()
{
	...
	'<div class="title">01/04/2024 - 2.019 (the "Landen DeGraphingCalcuator who makes Calcuations in Algebra 1 which he has a 50 in like actually bro you will fail out the class so please join the algebra enrichment programr which i think your already joining but just try not to fail marking peroid 1 otherwise you may be executed because of sigma skibidi parents maybe idk mr sigma" update)</div>'+
	'<div class="listing">&bull; game has been renamed to "Landen DeGraff Clicker" to avoid confusion</div>'+
